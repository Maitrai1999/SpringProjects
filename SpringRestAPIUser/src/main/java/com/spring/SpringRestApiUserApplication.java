...
public class SpringRestApiUserApplication {
	static final Logger logger = LogManager.getLogger(SpringRestApiUserApplication.class);
	public static void main(String[] args) {
ApplicationContext context =SpringApplication.run(SpringRestApiUserApplication.class, args);
logger.info("hello!!");
